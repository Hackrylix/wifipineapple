...
if (!isset($strings))
{
    ...
    if (file_exists($languageFile))
        ...
        require("/pineapple/includes/languages/english-" . $version . ".php");
}
?>
...
<div class=navbar>
    ...
    <a href="/index.php?3g"><font color="black"><b><?= $strings["navbar-3g"] ?></b></font></a> | 
    ...
    <a href="/index.php?upgrade"><font color="black"><b><?= $strings["navbar-upgrade"] ?></b></font></a> | 
