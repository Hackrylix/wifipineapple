...
<div class=sidePanelLeft style="min-width:400px;">
    ...
    {
        echo $strings["ssh-boot"] . " <font color=\"red\"><b>" . $strings["ssh-disabled"] . "</b></font>. | <a href=\"index.php?ssh&enable\"><b>" . $strings["ssh-enable"] . "</b></a><br />";
    }
    if (exec("grep ssh-keepalive.sh /etc/crontabs/root") == "")
    {
    ...
    {
        echo $strings["ssh-persist"] . " <font color='lime'><b>" . $strings["ssh-enabled"] . "</b></font>.&nbsp; | <a href='index.php?ssh&disablekeepalive'><b>" . $strings["ssh-disable"] . "</b></a><br />";
    }
    if (exec("ps aux | grep [s]sh | grep -v -e ssh.php | grep -v grep") == "")
    {
