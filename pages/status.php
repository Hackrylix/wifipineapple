...
<div class=sidePanelLeft>
    ...
    <div class=sidePanelContent>
        ...
        {
            echo "&nbsp;Wireless  <font color=\"red\"><b>" . $strings["status-disabled"] . "</b></font>. | <a href=\"wifi/wlan.php?start\"><b>" . $strings["status-start"] . "</b></a><br />";
        }
        ...
        {
            echo "MK4 Karma  <font color=\"red\"><b>" . $strings["status-disabled"] . "</b></font>. | <a href=\"karma/startkarma.php\"><b>" . $strings["status-start"] . "</b></a> <br />";
        }
        ...
        {
            echo "Autostart  <font color=\"red\"><b>" . $strings["status-disabled"] . "</b></font>. | <a href=\"karma/autoKarmaStart.php\"><b>" . $strings["status-start"] . "</b></a><br />";
        }
        ...
        {
            echo "Cron Jobs <font color=\"red\"><b>" . $strings["status-disabled"] . "</b></font>. | <a href=\"index.php?jobs&start&goback\"><b>" . $strings["status-start"] . "</b></a> | <a href=\"index.php?jobs\"><b>Edit</b></a><br />";
        }
        ...
        {
            echo "URL Snarf  <font color=\"red\"><b>" . $strings["status-disabled"] . "</b></font>. | <a href=\"urlsnarf/starturlsnarf.php\"><b>" . $strings["status-start"] . "</b></a><br />";
        }
        ...
        {
            echo "DNS Spoof  <font color=\"red\"><b>" . $strings["status-disabled"] . "</b></font>. | <a href=\"dnsspoof/startdnsspoof.php\"><b>" . $strings["status-start"] . "</b></a> | <a href=\"index.php?config#dnsspoof\"><b>" . $strings["status-edit"] . "</b></a><br/>";
        }
        ...
        {
            echo "3G bootup <font color=\"red\"><b>" . $strings["status-disabled"] . "</b></font>. | <a href=\"index.php?3g&enable&goback\"><b>" . $strings["status-enable"] . "</b></a><br />";
        }
        ...
        {
            echo "3G redial <font color='lime'><b>" . $strings["status-enabled"] . "</b></font>.&nbsp; | <a href='index.php?3g&disablekeepalive&goback'><b>" . $strings["status-disable"] . "</b></a><br />";
        }
    ...
    <div class=sidePanelContent>
        ...
        if (isset($_GET[revealpublic]))
        {
            ...
            if ($ip != "")
                ...
                echo "<font color=red>" . $strings["status-connectionError"] . "</font><br />";
        } else
        {
