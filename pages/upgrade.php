...
if($remoteVersion[0] > $localVersion[0]){
	$upgradeMessage = $strings["upgrade-found"]." ($remoteVersion[0].$remoteVersion[1].$remoteVersion[2]) | <a href=\"?upgrade&doOTA\">".$strings["upgrade-doUpgrade"]."</a>";
		...
		$upgradeMessage = $strings["upgrade-found"]." ($remoteVersion[0].$remoteVersion[1].$remoteVersion[2]) | <a href=\"?upgrade&doOTA\">".$strings["upgrade-doUpgrade"]."</a>";
			...
			$upgradeMessage = $strings["upgrade-found"]." ($remoteVersion[0].$remoteVersion[1].$remoteVersion[2]) | <a href=\"?upgrade&doOTA\">".$strings["upgrade-doUpgrade"]."</a>";
                }else $upgradeMessage = $strings["upgrade-notFound"]." <a href=\"?upgrade&doOTA\">".$strings["upgrade-reflash"]." $remoteFile[0]?</a>";
        }else $upgradeMessage = $strings["upgrade-notFound"]." <a href=\"?upgrade&doOTA\">".$strings["upgrade-reflash"]." $remoteFile[0]?</a>";
}else $upgradeMessage = $strings["upgrade-notFound"]." <a href=\"?upgrade&doOTA\">".$strings["upgrade-reflash"]." $remoteFile[0]?</a>";
}}
...
<tr><td>MD5:</td><td><input type="text" name="md5sum"></td></tr></table>
