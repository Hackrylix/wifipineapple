...
if(isset($_POST[persistent])){
	if($_POST[persistent] == "No") echo "<script type=text/javascript>window.location=\"?upgrade&doOTA\";</script>";
	else{
...
<tr><td>Keep Infusions?</td><td><select name="persistent"><option>No</option><option>Yes</option></select></td></table>
