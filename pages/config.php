...
if (isset($_GET[updateLanguages]))
{
    ...
    if (trim($connection) != "")
    {
        ...
        $languageMessage = "<font color=red>" . $strings["config-language-error"] . "</font><br /><br />";
}
?>
    ...
    <div class=contentContent>
        <center><?= $strings["config-language-current"] ?> <?= $language ?>.<br />
            ...
            <div class=contentContent>
                ...
                ?>
                Reset button <?php if ($resetButton == "enabled") echo "<font color=lime>" . $strings["config-button-resetEnabled"] . "</font>"; else echo "<font color=red>" . $strings["config-button-resetDisabled"] . "</font>" ?>. | <?php if ($resetButton == "enabled") echo "<a href=\"index.php?config&resetButton=disable\">" . $strings["config-button-resetDisable"] . "</a>"; else echo "<a href=\"index.php?config&resetButton=enable\">" . $strings["config-button-resetEnable"] . "</a>"; ?>
                <br /><br />
                <?php
